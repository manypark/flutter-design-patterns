...
import '../widgets/concrete_classes/concrete_classes.dart';
import '../widgets/directory.dart';
import '../widgets/files_dialog.dart';
import '../widgets/files_visitor_selection.dart';
import '../widgets/ifile.dart';
import '../widgets/visitors/xml_visitor.dart';
import '../widgets/visitors/human_readable_visitor.dart';

class VisitorExampleScreen extends StatefulWidget {

  static String path = '/visitor-example-screen';

  const VisitorExampleScreen({super.key});

  @override
  VisitorExampleState createState() => VisitorExampleState();
}

class VisitorExampleState extends State<VisitorExampleScreen> {
